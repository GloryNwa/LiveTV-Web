...
Route::group(['middleware' => ['CheckAuth']], function () {
    ...
    Route::get('/catchup/video/{video_id}/{cat_id}', 'LiveTvController@liveTVPlayer')->name("liveTVPlayer");
    ...
    Route::get('/livetv/stations/{id}', 'LiveTvController@view_live')->name("view_live");

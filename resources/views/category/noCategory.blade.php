...
<body>
    ...
    <div id="wrapper" data-scrollable="true">
        <aside id="sidebar" class="sidebar-primary">
            <div class="sidebar-header d-flex align-items-center"><a href="#" class="brand"><img src="/assets/img/logo-icon.png" alt="LiveTV" style="width:100px; "> </a><button type="button" class="btn p-0 ml-auto" id="hideSidebar"><i class="ion-md-arrow-back h3"></i></button> <button type="button" class="btn toggle-menu" id="toggleSidebar"><span></span> <span></span> <span></span></button></div>
            <nav class="navbar">
                <ul class="navbar-nav" data-scrollable="true">
                    <li class="nav-item nav-header">Browse Categories</li>
                    <li class="nav-item"><a href="{{route('home')}}" class="nav-link active"><i class="la la-home"></i><span>Home</span></a></li>
        ...
        <main id="pageWrapper">
            <header id="header" class="bg-primary">
                <div class="d-flex align-items-center"><button type="button" class="btn toggle-menu mr-3" id="openSidebar"><span></span> <span></span> <span></span></button>
                    ...
                    <form action="#" id="searchForm"><button type="button" class="btn ion-ios-search"></button> <input type="text" placeholder="Browse Category..." id="searchInput" class="form-control">
                    ...
                    <ul class="header-options d-flex align-items-center">
                        ...
                        <li class="dropdown fade-in"><a href="javascript:void(0);" class="d-flex align-items-center py-2" role="button" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="avatar avatar-sm avatar-circle"><img src="../assets/images/users/thumb.jpg" alt="user"></div><span class="pl-2"> Admin</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userMenu"><a class="dropdown-item" href="{{route('profile')}}"><i class="ion-md-contact"></i> <span>Profile</span></a>
                                ...
                                <div class="px-4 py-2"><a href="{{route('logout')}}" class="btn btn-sm btn-key btn-pill btn-danger">Logout</a></div>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 pb-4">
                            <ul class="list-unstyled h-bg-1-dark">
                                ...
                                <div class="custom-card mb-3"><a href="/single/category/{{$cat->category_id}}" class="text-dark">

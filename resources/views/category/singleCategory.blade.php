...
<div class=""></div>
<h4>{{$response->data[0]->category}}</h4><br>
<div class="row section">
    @if(count($response->data) > 0)
    @foreach($response->data as $cat)
    <div class="col-xl-3 col-lg-4 col-sm-6 pb-4">
        <div class="custom-card">
            <div class="custom-card--img"><a href="/catch/up/{{$cat->video_id}}"><img src="{{$cat->banner}}" alt="" class="card-img--radius-lg"></a></div><a href="/catch/up/{{$cat->video_id}}" class="custom-card--link mt-2">

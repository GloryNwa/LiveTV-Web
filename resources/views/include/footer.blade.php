<footer id="footer" class="bg-img">
    <div class="footer-content"><a class="email">Welcome to LiveTV Web<br></a>
        <p>Enjoy Unlimited Access To All Live Programs with Pastor Chris</p>
        <div class=""><a href="https://play.google.com/store/apps/details?id=com.celivetv.mobile2" class="btn btn-dark btn-air platform-btn" target="_blank"><i class="ion-logo-android"></i>
            ...
            <a href="https://play.google.com/store/apps/details?id=com.celivetv.mobile2" class="btn btn-danger btn-air platform-btn" target="_blank"><i class="ion-logo-apple"></i>

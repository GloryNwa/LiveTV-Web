        ...
        song: function() {
            ...
            new Chart(t, {
                ...
                options: {
                    ...
                    scales: {
                        yAxes: [{ display: !1, ticks: { min: 0, max: 85 } }],
                        xAxes: [{ display: !1, barPercentage: 0.5 }],
                    },
                    layout: { padding: 0, margin: 0 },
                },
            });
        ...
        AppConfig = {
            ...
            filterLink: function(t) {
                return (
                    ...
                    !(
                        t.length >= 10 &&
                        "javascript" === t.substr(0, 10).toLowerCase()
                    ) &&
                    !(t.length < 1)
                );
            },
            ...
            addFavorite: function() {
                ...
                t.on("click", function(t) {
                    ...
                    if (
                        i.length &&
                        !e.find(".custom-card--labels li .la-heart").length
                    )
                        i.append(s);
                    else {
                        e.prepend(
                            '<ul class="custom-card--labels d-flex"><li><span class="badge badge-pill badge-danger"><i class="la la-heart"></i></span></li></ul>'
                        );
                    }
                });
            },
            ...
            volumeIconClick: function() {
                ...
                t.on("change", function() {
                    var t = $(this),
                        e = parseInt(t.val(), 10);
                    0 === e ?
                        s.html('<i class="ion-md-volume-mute"></i>') :
                        e > 0 && e < 70 ?
                        s.html('<i class="ion-md-volume-low"></i>') :
                        e > 70 && s.html('<i class="ion-md-volume-high"></i>');
                });
            },
    ...
    (function(t, s, e, i) {
        function a(e, i) {
            ...
            null != t.cookie("themeSetting") &&
                !1 === i &&
                ((this.cookiesOptions = JSON.parse(
                        t.cookie("themeSetting")
                    )),
                ...
                (this.optionList = [
                    { text: "Dark Theme", value: this.options.darkTheme },
                ]);
        ...
        (a.prototype.initialize = function() {
            ...
            this.options.darkTheme && this.$body.addClass("theme-dark"),
                s.addClass(
                    "bg-" + this.options.themeClass[this.options.header]
                ),
                e.addClass(
                    "sidebar-" +
                    this.options.themeClass[this.options.sidebar]
                ),
                i.addClass(
                    "player-" + this.options.themeClass[this.options.player]
                ),
        ...
        (a.prototype.settingsButtonElement = function() {
            ...
            Object.assign(s, t),
                (s.innerHTML = this.options.settingIcon),
                this.$body.append(s),
                this.themeOptions();
        }),
        (a.prototype.themeOptions = function() {
            ...
            for (
                var s =
                    '<div class="theme-settings-body"><ul class="' +
                    this.options.listClass +
                    '">',
                    i = 0; i < this.optionList.length; i++
            ) {
            ...
            s +=
                '<li class="custom-list-group--item-separator"></li><li class="custom-list-group--item custom-list-group--item-header">Header Colors</li><li class="' +
                this.options.listItemClass +
                '">';
            for (var o = 0; o < this.options.themeClass.length; o++) {
                var n = o === this.options.header ? "active" : "";
                s +=
                    '<a href="javascript:void(0);" class="header-skin bg-' +
                    this.options.themeClass[o] +
                    " " +
                    n +
                    '" data-header-skin="' +
                    o +
            ...
            (s += "</li>"),
            (s +=
                '<li class="custom-list-group--item-separator"></li><li class="custom-list-group--item custom-list-group--item-header">Sidebar Colors</li><li class="' +
                this.options.listItemClass +
                '">');
            for (var l = 0; l < this.options.themeClass.length; l++) {
                var r = l === this.options.sidebar ? "active" : "";
                s +=
                    '<a href="javascript:void(0);" class="sidebar-skin bg-' +
                    this.options.themeClass[l] +
                    " " +
                    r +
                    '" data-sidebar-skin="' +
                    l +
            ...
            (s += "</li>"),
            (s +=
                '<li class="custom-list-group--item-separator"></li><li class="custom-list-group--item custom-list-group--item-header">Player Colors</li><li class="' +
                this.options.listItemClass +
                '">');
            for (var d = 0; d < this.options.themeClass.length; d++) {
                var c = d === this.options.player ? "active" : "";
                s +=
                    '<a href="javascript:void(0);" class="player-skin bg-' +
                    this.options.themeClass[d] +
                    " " +
                    c +
                    '" data-player-skin="' +
                    d +
            ...
            (s += "</ul></div>"),
            (t.innerHTML =
                '<header><span class="title-bold font-md text-uppercase">Theme Settings</span><a href="javascript:void(0)" class="ml-auto"><i class="ion-md-close"></i></a></header>' +
                s),
            this.$body.append(t);
        }),
        (a.prototype.skinClicks = function() {
            ...
            this.$body.on("click", "#to0", function() {
                    var e = t(this);
                    (s.cookiesOptions.themeDark = e[0].checked),
                    s.$body.toggleClass("theme-dark"),
                        s.setCookies();
                }),
                this.$body.on("click", ".header-skin", function() {
                    var e = t(this),
                        i = e.data("header-skin");
                    (s.cookiesOptions.header = i),
                    a.removeClass(),
                        a.addClass("bg-" + s.options.themeClass[i]),
                ...
                this.$body.on("click", ".sidebar-skin", function() {
                    ...
                    (s.cookiesOptions.sidebar = i),
                    o.removeClass(),
                        o.addClass("sidebar-" + s.options.themeClass[i]),
                ...
                this.$body.on("click", ".player-skin", function() {
                    ...
                    (s.cookiesOptions.player = i),
                    n.removeClass(),
                        n.addClass("player-" + s.options.themeClass[i]),
        ...
        (a.prototype.setCookies = function() {
            t.cookie("themeSetting", JSON.stringify(this.cookiesOptions), {
                expires: 7,
                path: "/",
            });
        }),
